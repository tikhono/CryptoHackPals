...
mod tests {
    ...
    fn capture_the_flg() {
        ...
        basis[0] = BigVector::from_vector(vec![
            Integer::from_str_radix("",16).unwrap(),
            n.clone(),

        ]);
        basis[1] = BigVector::from_vector(vec![n.clone().sqrt(), Integer::from(0)]);
        ...
        let d1 = &basis[0][1] / n.clone().sqrt();
        let d2 = &basis[1][1] / n.clone().sqrt();
